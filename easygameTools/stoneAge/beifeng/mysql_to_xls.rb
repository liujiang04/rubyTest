...
$user = 'root'
$passwd = 'root'
$database = "stone-foreigh-project"
if not $isLocal
  $host = '192.168.1.207'
  $passwd = ''
end

$SVNPATH = '/Users/admin/Documents/ljworkspace/local/egret/design/stone_age/stone_foreign/translateProject/'

$ccbSql = 'xmlTranslate'
$coffeeSql = 'TsTranslate'
